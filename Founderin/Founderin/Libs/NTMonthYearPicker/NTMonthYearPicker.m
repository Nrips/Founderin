...
@property (nonatomic, strong) UILabel *lblOld;
...
{
    if (self.lblOld != nil)
        self.lblOld.backgroundColor = [UIColor clearColor];
...
//    self.lblSelected.backgroundColor = [UIColor redColor];
//    [self.lblSelected setNeedsDisplay];
//    self.lblOld = self.lblSelected;
    
    // Create (or reuse) the label instance
    
    self.lblSelected = (UILabel *)view;
    if( self.lblSelected == nil ) {
        CGSize rowSize = [pickerView rowSizeForComponent:component];
        self.lblSelected = [[UILabel alloc] initWithFrame:CGRectMake(25, 0, rowSize.width, rowSize.height)];
        self.lblSelected.font = [UIFont systemFontOfSize:20];
        self.lblSelected.textAlignment = NSTextAlignmentLeft;
...
//        }
        ...
        self.lblSelected.adjustsFontSizeToFitWidth = YES;
    }
    
    UIView *v = [_pickerV viewForRow:row forComponent:component];
    
    if (v != nil)
    {
        self.lblSelected.textColor = [UIColor greenColor];
    }
    ...
    self.lblSelected.text = [(isYearComponent ? _years : _months) objectAtIndex:row];
    self.lblSelected.textColor = (outOfBounds ? [UIColor grayColor] : [UIColor blackColor]);
...
//    
//    if([_pickerV selectedRowInComponent:component] == row) //this is the selected one, change its color
//    {
//        self.lblSelected.textColor = [UIColor redColor];
//    }
//    
//    return self.lblSelected;
//}
